...
import { ArrowRight, Heart, MapPin, Bed, Bath, Ruler, Trash2 } from 'lucide-react';
    ...
    <div className="min-h-screen bg-background safe-area-inset">
      ...
      >
        <div className="flex items-center gap-4 mb-4">
          ...
          <h1 className="font-serif text-2xl font-bold text-foreground">المفضلة</h1>
        </div>
      </motion.header>
      ...
      <div className="px-6 pb-6 space-y-4">
        {isLoading ? (
          ...
          >
            ...
            <p className="text-foreground font-medium mb-2">لا توجد عقارات في المفضلة</p>
            <p className="text-sm text-muted-foreground">
              أضف العقارات التي تعجبك للعودة إليها لاحقاً
            </p>
          </motion.div>
        ) : (
            ...
            >
              ...
              <div className="relative h-48 bg-gradient-to-br from-muted to-surface-elevated flex items-center justify-center">
                ...
                <button
                  onClick={(e) => {
                    e.stopPropagation();
                    setRemoveConfirm(property.id);
                  }}
                  className="absolute top-3 left-3 w-10 h-10 rounded-full bg-background/80 backdrop-blur-sm flex items-center justify-center hover:bg-destructive/20"
                >
      ...
      <ConfirmDialog
        ...
        description="هل أنت متأكد من إزالة هذا العقار من المفضلة؟"
        confirmLabel="إزالة"
        cancelLabel="إلغاء"
